(function(){
  ...
  async function ogrenciSil(id){const r=await rpc('ogrenci_sil_guvenli_v1',{p_ogrenci_id:id});window.BSReferansServisi?.temizle?.();document.dispatchEvent(new CustomEvent('bs:veri-degisti',{detail:{konu:'ogrenci-sil',sonuc:r}}));return r;}
