...
const checks = [
  ...
  ['Öğrenci WhatsApp alıcısında önce veli telefonu kullanılır', programShare.includes("student?.veli_telefon||student?.ogrenci_telefon||''")],
  ...
  ['Program mesajına Zoom bağlantısı eklenmez', !programShare.includes('zoom_katilim_baglantisi}`') && !programShare.includes('Zoom Dersine Katıl')],
