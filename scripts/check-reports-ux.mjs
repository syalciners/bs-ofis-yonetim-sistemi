...
const checks = [
  ...
  ['Öğretmen raporu ve PDF ders_sayisi toplamını Ders Saati olarak adlandırır', reports.includes('Yapılan Ders Saati') && reports.includes('Ders Saati</span>') && teacherPdf.includes("{text:'DERS SAATİ',style:'th',alignment:'right'}") && teacherPdf.includes("metric('Yapılan Ders Saati'")],
  ...
  ['Kurum finansal durum KPI alanları var', reports.includes('Öğrenci Bakiyesi') && reports.includes('Öğretmen Borcu') && reports.includes('Kasa / Banka')],
  ...
  ['Kurum yapılan ders saati etiketi ders_sayisi toplamıyla uyumludur', reports.includes('Yapılan Ders Saati') && institutionPdf.includes("metric('Yapılan Ders Saati'")],
  ['Kurum yapılan ders KPI gerçek ders_sayisi toplamıdır', reports.includes('completedInstitutionLessons.reduce((sum, x) => sum + Number(x.ders_sayisi || 1), 0)') && reports.includes('completedLessons: completedLessonsForPdf.reduce((sum, x) => sum + Number(x.ders_sayisi || 1), 0)')],
  ['Kurum PDF finansal durum ve ders dağılımını korur', institutionPdf.includes('Öğrenci Bakiyesi') && institutionPdf.includes('Öğretmen Borcu') && institutionPdf.includes('Kasa / Banka') && institutionPdf.includes('Program Durumu Dağılımı')],
