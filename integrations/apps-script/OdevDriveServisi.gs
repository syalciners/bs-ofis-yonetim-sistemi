...
function doPost(e) {
  try {
    ...
    const expectedSourcePrefix = SUPABASE_URL + '/storage/v1/object/sign/odev-ekleri/';
    if (sourceUrl.indexOf(expectedSourcePrefix) !== 0) throw new Error('Geçersiz dosya bağlantısı.');
