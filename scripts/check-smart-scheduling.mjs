...
const checks=[
  ...
  ['Haftayı Oluştur üretimden önce ön kontrol yapar',calendar.indexOf('await reviewWeekPlanning(monday)')>=0&&calendar.indexOf('await reviewWeekPlanning(monday)')<calendar.indexOf('await createWeek(monday)')],
