...
const checks=[
  ...
  ['Sabit Program görünüm düğmesi mobilde özet satırının sağında kalır',fixedCss.includes('.fixed-program-summary-toolbar{display:flex!important;align-items:center!important;justify-content:space-between!important')&&fixedCss.includes('.fixed-program-summary-toolbar .fixed-program-view-toggle')&&fixedCss.includes('margin-left:auto!important')&&!fixedCss.includes('.fixed-program-view-switch')],
