import { Bell, BookOpenCheck, FileBarChart, GraduationCap, HeartPulse, Repeat2, Settings } from 'lucide-react'
...
export function MorePage(){
  ...
  const items=[
    ...
    ...(isManager?[{to:'/bildirimler',Icon:Bell,title:'Bildirimler',text:'Operasyon ve sistem uyarıları'}]:[]),
