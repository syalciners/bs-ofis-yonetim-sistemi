...
export function SystemPage(){
  ...
  return <div className="page-stack">
    <section className="page-title-row"><div><span className="eyebrow">SİSTEM</span><h1>Sistem Durumu</h1><p>Veriler ve ders programı için hızlı sağlık kontrolü.</p></div><button className="secondary-btn" onClick={()=>void refresh()}><RefreshCw size={17} className={refreshing?'spin':''}/>Veriyi Yenile</button></section>
