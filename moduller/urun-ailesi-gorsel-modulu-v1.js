(function(){
  ...
  function stilEkle(){
    ...
    s.textContent=`
      /* V266 — BS ürün ailesi görsel standardı. Yalnız bileşenleri biçimlendirir; sayfa kaydırmasına dokunmaz. */
      :root{--bsu-mavi:#2563eb;--bsu-mavi-acik:#eff6ff;--bsu-yazi:#0f172a;--bsu-ikincil:#64748b;--bsu-kenar:#e2e8f0;--bsu-zemin:#f5f7fb;--bsu-yesil:#16a34a;--bsu-golge:0 7px 24px rgba(15,23,42,.05)}

      #gorunum-anasayfa .sayfa-aciklama{color:var(--bsu-ikincil)}
      :is(#gorunum-ogrenciler,#gorunum-tahsilat,#gorunum-sabitprogram,#gorunum-ogretmenler,#gorunum-giderler,#gorunum-raporlar,#gorunum-kasa,#gorunum-ogretmen-odemeleri,#gorunum-odevler) .sayfa-baslik{color:var(--bsu-yazi)!important;font-weight:850!important;letter-spacing:-.02em!important}
      :is(#gorunum-ogrenciler,#gorunum-tahsilat,#gorunum-sabitprogram,#gorunum-ogretmenler,#gorunum-giderler,#gorunum-raporlar,#gorunum-kasa,#gorunum-ogretmen-odemeleri,#gorunum-odevler) .sayfa-aciklama{color:var(--bsu-ikincil)!important}
      :is(#gorunum-ogrenciler,#gorunum-tahsilat) .ana-islem-buton{min-height:44px!important;height:auto!important;padding:0 15px!important;border:1px solid var(--bsu-mavi)!important;border-radius:13px!important;background:var(--bsu-mavi)!important;color:#fff!important;box-shadow:0 7px 18px rgba(37,99,235,.16)!important;font-weight:800!important}
