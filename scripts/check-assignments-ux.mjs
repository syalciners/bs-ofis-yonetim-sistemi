...
const checks=[
  ...
  ['Ödev formu Drive arşiv akışını çağırır',editor.includes('archiveAssignmentAttachmentsToDrive')&&editor.includes('Ekler Google Drive’da öğrencinin klasöründe saklanır')],
  ...
  ['Drive servisi mevcut ÖDEVLER klasörünü kullanır',appsScript.includes("ODEV_ROOT_FOLDER_ID = '1pi9sIusouzL_fDvHwsjEtLlbY9Un_tCw'")],
  ...
  ['Drive servisi dosyayı geçici imzalı URL üzerinden alır',appsScript.includes('UrlFetchApp.fetch(sourceUrl')&&!appsScript.includes('base64Decode')],
